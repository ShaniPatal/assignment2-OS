...
main(int argc, char *argv[])
{
  ...
  12:	49a9                	li	s3,10
            printf("pid = %d\n",pid);
  14:	00000a17          	auipc	s4,0x0
  18:	7dca0a13          	addi	s4,s4,2012 # 7f0 <malloc+0xe4>
    for(int i=0;i<100;i++){
  1c:	06400913          	li	s2,100
  20:	a809                	j	32 <main+0x32>
            printf("pid = %d\n",pid);
  22:	8552                	mv	a0,s4
  24:	00000097          	auipc	ra,0x0
  28:	62a080e7          	jalr	1578(ra) # 64e <printf>
    for(int i=0;i<100;i++){
  2c:	2485                	addiw	s1,s1,1
  2e:	01248c63          	beq	s1,s2,46 <main+0x46>
        int pid = fork();
  32:	00000097          	auipc	ra,0x0
  36:	28c080e7          	jalr	652(ra) # 2be <fork>
  3a:	85aa                	mv	a1,a0
        if(pid != 0){
  3c:	f17d                	bnez	a0,22 <main+0x22>
        } else if(i%10 != 0)while (1);
  3e:	0334e7bb          	remw	a5,s1,s3
  42:	d7ed                	beqz	a5,2c <main+0x2c>
  44:	a001                	j	44 <main+0x44>
    }
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3be:	44e50513          	addi	a0,a0,1102 # 808 <digits>
 3c2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 48a:	382b8b93          	addi	s7,s7,898 # 808 <digits>
 ...
 5ca:	23a90913          	addi	s2,s2,570 # 800 <malloc+0xf4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 692:	1927b783          	ld	a5,402(a5) # 820 <freep>
 ...
 6c0:	00e6ea63          	bltu	a3,a4,6d4 <free+0x50>
{
 ...
 702:	12f73123          	sd	a5,290(a4) # 820 <freep>
}
 706:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 734:	0f053503          	ld	a0,240(a0) # 820 <freep>
 ...
 75c:	0c890913          	addi	s2,s2,200 # 820 <freep>
  if(p == (char*)-1)
 760:	5afd                	li	s5,-1
 762:	a88d                	j	7d4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 764:	00000797          	auipc	a5,0x0
 768:	0c478793          	addi	a5,a5,196 # 828 <base>
 76c:	00000717          	auipc	a4,0x0
 770:	0af73a23          	sd	a5,180(a4) # 820 <freep>
 774:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 796:	08a73723          	sd	a0,142(a4) # 820 <freep>
      return (void*)(p + 1);
